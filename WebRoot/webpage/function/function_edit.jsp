...
$(document).ready(function() {	
	$('#cc').combotree({  
		...
		value : ${requestScope.pojo.parentid},
...
function save(){
	...
	forms.action = "<%=basePath %>functionController.do?updateObj";
	forms.submit();
	//操作父页面tab重新刷一次
...
<div class="grid_4">
  <div class="da-panel">
    ...
    <div id="da-ex-val1-error" class="da-message info" style=" display:none">至少选择一个角色，默认是管理员</div>
      ...
      <input type="hidden" value="${requestScope.pojo.id}" name="id"/>
        <div class="da-form-inline">
          <div class="da-form-row">
            <label>菜单名称：<span class="required">*</span></label>
            <div class="da-form-col-3-8">
              <input type="text" class="padding" id="nodename" name="nodename" value="${requestScope.pojo.nodename}" style="width:60%"/>
              <span></span></div>
          ...
          <div class="da-form-row">
            ...
            <div class="da-form-col-3-8">
              <input class="padding" name="nodeurl" id="nodeurl" value="${requestScope.pojo.nodeurl}" type="text" style="width:60%;"/>
            </div>
          ...
          <div class="da-form-row">
            ...
            <div class="da-form-col-3-8">
              ...
              <c:if test="${requestScope.pojo.nodeview==1}">
                <li>
                <input type="radio" name="nodeview" value="0" checked="checked" />
                <label>是</label>
                </li>
                <li>
                <input type="radio" name="nodeview" value="1" />
                <label>否</label>
                </li>
				</c:if>
                <c:if test="${requestScope.pojo.nodeview==0}">
                <li>
                <input type="radio" name="nodeview" value="0" />
                <label>是</label>
                </li>
                <li>
                <input type="radio" name="nodeview" value="1" checked="checked" />
                <label>否</label>
                </li>
				</c:if>
          ...
          <div class="da-form-row">
            <label>备注：</label>
            <div class="da-form-col-3-8">
              <textarea class="padding" rows="auto" cols="auto" name="remark">${requestScope.pojo.remark}</textarea>
            </div>
          </div>
