...
function save(){
	...
	forms.action = "<%=basePath %>roleController.do?updateObj";
	forms.submit();
	//操作父页面tab重新刷一次
        ...
        <div class="da-form-inline">
          <div class="da-form-row">
            <label>角色名：<span class="required">*</span></label>           
              <input type="text" name="rolename" type="text" id="rolename" class="padding" value="${requestScope.pojo.rolename}"/>                                            
          </div>
          <div class="da-form-row">
            <label>备注：</label>          
              <textarea rows="auto" cols="auto" name="remark" class="padding">${requestScope.pojo.remark}</textarea>          
          </div>
