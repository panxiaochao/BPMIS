...
public class CommonDao extends GenericBaseCommonDao implements ICommonDao, IGenericBaseCommonDao {
	 ...
	 * 检查用户是否存在
	 * */
	public TBUser getUserByUserIdAndUserNameExits(TBUser user) {
//		String password = PasswordUtil.encrypt(user.getAccount(), user.getPwd(), PasswordUtil.getStaticSalt());
//		List<TBUser> users = findByQueryString("from TSUser u where u.userName = '" + user.getAccount() + "' and u.password='" + password + "'");
